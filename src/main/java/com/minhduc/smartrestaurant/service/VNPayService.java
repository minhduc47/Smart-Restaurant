...
public class VNPayService {
    ...
    @Value("${minhduc.vnpay.tmn-code}")
    private String vnp_TmnCode;

    @Value("${minhduc.vnpay.hash-secret}")
    private String secretKey;

    @Value("${minhduc.vnpay.vnp-return-url}")
    private String vnp_ReturnUrl;

    @Value("${minhduc.vnpay.vnp-url}")
    private String vnp_PayUrl;

    public String generateVNPayURL(long amountValue, String paymentRef, String ip)
